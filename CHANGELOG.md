...
### Changed
- WPF prompt, activity/log/undo, environment snapshot/freshness, and Custom
  settings search state now live in dedicated state-domain view models while
  preserving the existing `MainViewModel` binding surface.
