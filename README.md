...
**Maintenance puts recovery first.** It shows the most important issue and one safe repair before any technical detail. Start Spotify in safe mode saves an exact copy of your Spicetify config and custom apps, checks the snapshot manifest and its SHA256 before recovery, opens Spotify without extensions or apps, then keeps one Restore my setup action ready. Diagnostics stay under one labeled section, and reset actions remain separate and collapsed until you choose to review them.
