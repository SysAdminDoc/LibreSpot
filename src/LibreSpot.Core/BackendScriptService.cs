...
public sealed class BackendScriptService
{
    ...
    {
        "Install", "CheckUpdates", "Reapply", "RepairMarketplace", "OpenMarketplace", "ExportMarketplaceState", "RestoreMarketplaceState", "SafeMode", "CreateBackup", "RestoreBackup", "RestoreVanilla", "UninstallSpicetify", "FullReset", "RemoveSelfData", "ClearCache",
